...
!function (t, e) {
    ...
    a.prototype = {
        constructor: a, getValue: function (t) {
            ...
            var t = this.getValue("sharer").toLowerCase(), e = {
                ...
                googleplus: {shareUrl: "https://plus.google.com/share", params: {url: this.getValue("url")}},
                linkedin: {
            ...
            var a, r = e.params || {}, s = Object.keys(r), i = s.length > 0 ? "?" : "";
            for (a = 0; a < s.length; a++)"?" !== i && (i += "&"), r[s[a]] && (i += s[a] + "=" + encodeURIComponent(r[s[a]]));
            if (e.shareUrl += i, e.isLink)t.location.href = e.shareUrl; else {
                var l = e.width || 600, h = e.height || 480, u = t.innerWidth / 2 - l / 2 + t.screenX, g = t.innerHeight / 2 - h / 2 + t.screenY, o = "scrollbars=no, width=" + l + ", height=" + h + ", top=" + g + ", left=" + u, p = t.open(e.shareUrl, "", o);
                t.focus && p.focus()
            }
        }
    }, t.addEventListener("load", function () {
        function t(t) {
            var e = t.currentTarget || t.srcElement, r = new a(e);
            r.share()
        }

        var r, s = e.querySelectorAll(".sharer"), i = s.length;
